...
{{-- MODAL REJECT --}}
<div x-data="{ show: @entangle('showRejectModal') }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Tolak Pengajuan</h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 mb-2">Silakan masukkan alasan penolakan untuk pengajuan ini.
                            </p>
...
{{-- MODAL ACCEPT --}}
<div x-data="{ show: @entangle('showAcceptModal') }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
